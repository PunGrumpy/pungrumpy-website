...
export function GalleryImage({ src, alt }: GalleryImageProps) {
  return (
    <div className="ease-&lsqb;cubic-bezier(0.2,0.8,0.2,1)&rsqb; group relative flex h-80 min-w-72 max-w-lg flex-1 flex-col items-start justify-start overflow-hidden rounded-3xl border border-border/50">
