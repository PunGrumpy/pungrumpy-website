      ...
      <div className="flex flex-wrap items-center justify-between gap-5">
        ...
        <div className="flex w-60 items-center rounded-[32px] border border-border bg-background p-3">
          <Input
            ...
            className="text-md h-12 rounded-[20px] border-none bg-transparent pr-10 leading-7 transition duration-300 ease-in-out"
          />
          <SearchIcon className="absolute right-6 size-5 text-muted-foreground" />
        </div>
      </div>
